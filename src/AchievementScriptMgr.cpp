...
namespace achievements_module
{
    ...
    bool AchievementScriptMgr::IsRealmCompleted(AchievementsModule const* globalmgr, AchievementEntry const* achievement, std::chrono::system_clock::time_point completionTime)
    {
        bool ret = true;
